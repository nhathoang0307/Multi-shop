  ...
  <div class="row px-xl-5">
    <div class="col-12">
      <nav class="breadcrumb bg-light mb-30">
        ...
        <span class="breadcrumb-item active">List New Customer</span>
      </nav>
    </div>
  </div>
</div>
...
<div class="toast" data-autohide="true" style="position: fixed; top: 10px; right: 10px; z-index: 1000000">
  <div class="toast-header">
    <strong class="mr-auto text-primary">Manager User</strong>
  ...
  <div class="row px-xl-5">
    ...
    <div class="col-lg-6 col-6 text-left">
        <div class="input-group">
          <input name="q" value="${requestScope.q}" type="text" class="form-control" value="" placeholder="Search for Customers" id="idTxtSearch">
    ...
    <div class="col-lg-12 table-responsive mb-5">
      <table class="table table-light table-borderless table-hover text-center mb-0">
        ...
        <c:forEach items="${requestScope.customerListNew}" var="customer1">
          <tr>
            <td class="align-middle">${customer1.getId()}</td>
            <td class="align-middle">${customer1.getFullName()}</td>
            <td class="align-middle">${customer1.getEmail()}</td>
            <td class="align-middle">${customer1.getPhoneNumber()}</td>
            <td class="align-middle">${customer1.getAddress()}</td>
            <td class="align-middle">${customer1.getCreatedTime()}</td>
            <c:choose>
              <c:when test="${customer1.getUpdatedTime()==null}">
                <td class="align-middle"></td>
              </c:when>
              <c:otherwise>
                <td class="align-middle">${customer1.getUpdatedTime()}</td>
              </c:otherwise>
            </c:choose>
            <td class="align-middle">
              ...
              <a href="#"
                 onclick="return confirm('Bạn có chắc chắn xóa ${customer1.getFullName()} không?');"><i
                      class="fa fa-times"
