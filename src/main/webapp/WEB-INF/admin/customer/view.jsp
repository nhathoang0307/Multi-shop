            ...
            <table class="table table-light table-borderless table-hover text-center mb-0">
                ...
                <c:forEach items="${requestScope.customerList}" var="customer">
                    <tr>
                        ...
                        <td class="align-middle">${customer.getEmail()}</td>
                        <td class="align-middle">${customer.getPhoneNumber()}</td>
                        <td class="align-middle">${customer.getAddress()}</td>
                        <td class="align-middle">${customer.getCreatedTime()}</td>
                        <c:choose>
                            <c:when test="${customer.getUpdatedTime()==null}">
                                <td class="align-middle"></td>
                            </c:when>
                            <c:otherwise>
                                <td class="align-middle">${customer.getUpdatedTime()}</td>
                            </c:otherwise>
                        </c:choose>
                        <td class="align-middle">
                            ...
                            <a href="#"
                               onclick="return confirm('Bạn có chắc chắn xóa ${customer.getFullName()} không?');"><i
                                    class="fa fa-times"
